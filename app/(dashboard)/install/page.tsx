...
export default function InstallPage() {
  ...
  const embedCode = `<script>!function(){var p="${config.position}",t="${config.theme}",i=document.createElement("iframe");i.src="https://heyapoyo.com/widget?spaceId=${activeSpaceId}&position="+p+"&theme="+t+"&parentUrl="+encodeURIComponent(window.location.href),i.setAttribute("allowtransparency","true"),i.style.cssText="position:fixed;bottom:0;"+("left"===p?"left:0;":"right:0;")+"width:120px;height:120px;border:none;z-index:999999;background:transparent;color-scheme:normal;",document.head.appendChild(document.createElement("meta")).setAttribute("name","viewport"),document.body.appendChild(i),window.addEventListener("message",function(e){if(e.data&&"kb-widget-resize"===e.data.type){var t=window.innerWidth<=430;e.data.isOpen?(i.style.width=t?"100%":"468px",i.style.height=t?"100%":"824px"):setTimeout(function(){i.style.width="120px",i.style.height="120px"},300)}})}();</script>`;
