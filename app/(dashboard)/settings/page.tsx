    ...
    <div className="flex flex-col h-full w-full bg-[#FAFAFA] text-gray-900 font-sans overflow-y-auto">
      <div className="max-w-[800px] mx-auto w-full p-8 pb-20 animate-in fade-in duration-300">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white border border-gray-200 rounded-sm p-6 shadow-sm">
            ...
            <div className="space-y-4">
              <div>
                ...
                <input 
                  ...
                  disabled={!isOwner}
                  className="w-full max-w-md p-2.5 border border-gray-200 rounded-sm text-sm outline-none focus:border-black transition-colors disabled:bg-gray-50 disabled:text-gray-400"
                />
              ...
              <div>
                ...
                <select 
                  ...
                  disabled={!isOwner}
                  className="w-full max-w-md p-2.5 border border-gray-200 rounded-sm text-sm outline-none focus:border-black bg-white transition-colors cursor-pointer disabled:bg-gray-50 disabled:text-gray-400"
                >
            ...
            <div className="mt-6 pt-4 border-t border-gray-100 flex justify-end">
               <button 
                ...
                className="bg-black text-white px-4 py-2 rounded-sm text-xs font-medium hover:bg-gray-800 transition-colors disabled:opacity-50"
               >
          ...
          {/* Danger Zone */}
          <div className="bg-white border border-red-100 rounded-sm p-6 shadow-sm">
            <h2 className="text-sm font-semibold text-red-600 mb-1">Danger Zone</h2>
            <p className="text-xs text-gray-500 mb-4">Irreversible actions for your workspace.</p>
            
            <div className="flex items-center justify-between p-4 bg-red-50/50 border border-red-100 rounded-sm">
               <div>
               ...
               <button 
                 disabled={true} 
                 className="px-4 py-2 bg-white border border-gray-200 text-red-600 text-xs font-medium rounded-sm hover:bg-red-50 hover:border-red-200 transition-colors cursor-not-allowed opacity-60"
